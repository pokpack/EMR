...
<html lang="en">
  <head>
    ...
    <title>Administrator :: <?php echo $title_view . " " . $this->session->userdata('wc_title'); ?> </title>
 ...
 <!-- end::Head -->
	...
	<body  class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
			<div class="m-grid__item m-grid__item--fluid m-grid m-error-4" style="background-image: url(<?= base_url(); ?>assets/app/media/img//error/bg4.jpg);">
